...
{
    public class PropertyPage : Website
    {
        ...
        public override string Url => $"{Configuration.Website}property/{Configuration.SampleProperty1}";

        public IWebElement AddFavoriteButton => Driver.FindElements("button", "MuiButton-outlinedSizeLarge", "", "", null, 2, 0,
            new List<string> {
